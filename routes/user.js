...
// @ENDPOINT http://localhost:5002/api/users/change-status
router.post("/users/change-status", authCheck, adminCheck, changeStatus);

// @ENDPOINT http://localhost:5002/api/users/change-role
router.post("/users/change-role", authCheck, adminCheck, changeRole);

// @ENDPOINT http://localhost:5002/api/users/update-image
router.post("/users/update-image", authCheck, updateProfileImage);

// @ENDPOINT http://localhost:5002/api/users/update-profile
router.post("/users/update-profile", authCheck, updateProfile);


// @ENDPOINT http://localhost:5002/api/users/:id
