...
import { Home, Calendar, Clock, User, Menu, X, LogOut, LayoutDashboard } from "lucide-react";
      ...
      <header className="hidden md:flex bg-white shadow-sm sticky top-0 z-40 px-6 py-4 justify-between items-center">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 font-medium">IT Support Portal</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-4">
          <div className="hidden lg:block text-right">
            ...
            <p className="text-xs text-gray-500 uppercase tracking-wide">{user?.role || "IT Support"}</p>
          </div>
