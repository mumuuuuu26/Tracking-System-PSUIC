...
const QuickFix = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50 pb-20 font-sans text-gray-900">
            ...
            {/* Content */}
            <div className="max-w-md md:max-w-2xl mx-auto lg:mx-0 mt-6 px-6 relative z-20 space-y-6">
                ...
                <div className="flex gap-3">
                    ...
                    <div className="relative">
                        <button
                            ...
                            className={`h-full px-4 rounded-xl border flex items-center justify-center gap-2 transition-all whitespace-nowrap shadow-sm ${selectedCategory !== "All"
