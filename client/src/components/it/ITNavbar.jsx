...
const ITNavbar = () => {
    ...
    const navLinks = [
        { name: "Home", path: "/it" },
        { name: "Tickets", path: "/it/tickets" },
        { name: "History", path: "/it/history" },
        { name: "Schedule", path: "/it/schedule" },
    ];
    ...
    return (
        <header className="bg-[#193C6C] shadow-md sticky top-0 z-50 font-sans text-white hidden md:block">
            <div className="max-w-7xl mx-auto px-4 md:px-8 py-5 flex items-center justify-start gap-10">
                ...
                <div className="flex items-center gap-5 ml-auto">
                    ...
                    <button
                        ...
                        className="p-2 relative hover:bg-white/10 rounded-full transition-colors text-gray-300 hover:text-white"
                        title="Notifications"
                    >
                        <Bell size={20} />
                        {/* We can add a badge here if there's a notification count in store */}
                    </button>
